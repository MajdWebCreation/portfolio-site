...
export const siteContent = {
  nl: {
    ...
    contact: {
      ...
      privacyNote: "Je gegevens gebruiken we alleen om je bericht te beantwoorden. Meer daarover in de",
    ...
    consent: {
      ...
      cookiesLink: "Cookieverklaring",
      preferencesTitle: "Cookievoorkeuren",
      back: "Terug",
      close: "Sluiten",
      necessaryLabel: "Noodzakelijk",
      necessaryStatus: "Altijd actief",
      necessaryText: "Nodig om de website te laten werken en om je keuze te onthouden. Hiervoor is geen toestemming nodig.",
  ...
  en: {
    ...
    contact: {
      ...
      privacyNote: "We use your details only to answer your message. More in the",
    ...
    consent: {
      ...
      cookiesLink: "Cookie statement",
      preferencesTitle: "Cookie preferences",
      back: "Back",
      close: "Close",
      necessaryLabel: "Necessary",
      necessaryStatus: "Always on",
      necessaryText: "Needed to run the website and to remember your choice. No consent is required for this.",
